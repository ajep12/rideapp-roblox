...
function RideApp.Start(HQ)
	...
	if not config.AttractionID then
		warn(
			"RideApp | AttractionID is missing from Configuration for "
	...
	local AttractionID = tostring(config.AttractionID)
	...
	local function getAvailableRoles(player)
		...
		for roleName, qualificationName in pairs(
			config.RequiredQualifications or {}
		) do

			local qualification =
				qualifications:FindFirstChild(qualificationName)
	...
	LoginRequest.OnServerEvent:Connect(
		function(
			player,
			action,
			value,
			...
			if tostring(requestAttractionID) ~= AttractionID then
				return
			end
			...
			if action == "Login" then
				...
				local qualifications =
					player:FindFirstChild("Qualifications")
				...
				local pin =
					qualifications:FindFirstChild("PIN")
	...
	local function getLocalTime()
		...
		local offset =
			parkConfig.TimezoneOffset.Value
	...
	local function OpenQueue()
		...
		if config.CloseLock == true
			and not isWithinOperatingHours() then
	...
	local function PromptClosure()
		...
		local frame =
			Tablet.Application.ClosureFrame
		...
		frame.Close.MouseButton1Click:Connect(
			function()
		...
		b.Fault.MouseButton1Click:Connect(
			function()
		...
		b.Capacity.MouseButton1Click:Connect(
			function()
		...
		b.ClosedToday.MouseButton1Click:Connect(
			function()
		...
		b.Delay.MouseButton1Click:Connect(
			function()
		...
		b.EStopP.MouseButton1Click:Connect(
			function()
		...
		b.GuestA.MouseButton1Click:Connect(
			function()
		...
		b.OpeningS.MouseButton1Click:Connect(
			function()
		...
		b.PowerF.MouseButton1Click:Connect(
			function()
		...
		b.StaffA.MouseButton1Click:Connect(
			function()
		...
		b.TempC.MouseButton1Click:Connect(
			function()
		...
		b.Weather.MouseButton1Click:Connect(
			function()
		...
		b.EssentialC.MouseButton1Click:Connect(
			function()
